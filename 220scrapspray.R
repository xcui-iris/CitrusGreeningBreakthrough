...
#replant 220 trees
# N =1000 0807 higher influx makes insecticides less valuable, but make resistant cultivar momre attractive. Modify here to make real life sense numbers
N =500
ell = 2
r = 0.05
  ...
  for (iii in 1:length(p_values)) {
    ...
    for (initial_age in 1:20) {
      ...
      for (t in 1:T) {
        ...
        # } else { 
        N_t[t+1] <- round(N_t[t] + beta * N_t[t] * (1 - (N_t[t]/K)) - gamma * N_t[t] + N)
        # }08/04 I deleted the constant influx of 0.8*N, 0807 I added it back, gamma changed to 0.86
...
saveRDS(list_of_allresults, file = "C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/220scrapspray.rds")
# Read the list_of_allresults from a .rds file
list_of_allresults <- readRDS("C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/220scrapspray.rds")
...
write.csv(flat_df, file = "C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/220scrapspray.csv")
