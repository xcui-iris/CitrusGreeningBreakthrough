...
for (scenario in 1:length(phi_values)) {
  ...
  for (initial_age in 1:20) {
    ...
    #didn't change for D=300, assumed the same starting point. 13 max for q. 
    ...
    for (ii in 1:T) {
      ...
      profits[ii] <- totalrevenue[ii]- C_I * ii- C_f * ii - C_M * ii - C_R
...
saveRDS(list_of_allresults, file = "C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/NPV_scrapspray220.rds")
# Read the list_of_allresults from a .rds file
list_of_allresults <- readRDS("C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/NPV_scrapspray220.rds")
...
write.csv(flat_df, file = "C:/Users/juanj/Desktop/RA/Research/citrus supply chain/modeling/results/NPV_scrapspray220.csv")
